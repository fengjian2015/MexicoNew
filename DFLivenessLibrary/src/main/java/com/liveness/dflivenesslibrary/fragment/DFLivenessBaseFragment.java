...
public class DFLivenessBaseFragment extends DFProductFragmentBase implements Camera.PreviewCallback {
    ...
    protected void initView() {
        ...
        mHasFaceHint = getActivity().getString(R.string.note_hold_still);
        mNoFaceHint = getActivity().getString(R.string.string_facematch_hint);
        mFaceNotValid = getActivity().getString(R.string.liveness_face_not_valid_hint);
