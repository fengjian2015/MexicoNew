...
public class FileStreamManager {
    ...
    public Rect saveCameraBitmap(File file, byte[] data, CameraType cameraType) {
        if (data == null) {
            return null;
        }
        ...
        try {
            ...
            try {
                if (cameraType == CameraType.FrontCamera) {
            ...
            Rect rect = new Rect(0, 0, realBitmap.getWidth(), realBitmap.getHeight());
